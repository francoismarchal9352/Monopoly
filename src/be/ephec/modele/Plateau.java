...
public class Plateau implements Serializable{
	...
	public void initCartes(){
		tabCartesChance.add(new CarteChance(partie,"Amende pour excés de vitesse: 10 euros.\n",1));
		tabCartesChance.add(new CarteChance(partie,"La banque vous verse un dividende de 50 euros.\n",2));
		tabCartesChance.add(new CarteChance(partie,"Vous étes imposé pour les restaurations de voirie.\n40 euros par maison et 115 euros par hôtel.\n",3));
		...
		tabCartesChance.add(new CarteChance(partie,"Sortez de prison.\nVous gardez cette carte jusqu'é ce qu'elle vous serve ou que vous la vendiez.\n",7));
