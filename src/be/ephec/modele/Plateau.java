...
public class Plateau {
	...
	public void initCases(){
		...
		this.tabCases[4] = new Taxe(partie,"Impôts sur le revenu");
		...
		this.tabCases[9] = new Propriete(partie,"Avenue de la République", "Bleu clair", 120, 50, 8, 40, 100, 300, 450, 600);
		...
		this.tabCases[12] = new Service(partie,"Compagnie de Distribution d'Électricité");
		...
		this.tabCases[26] = new Propriete(partie,"Faubourg Seint-Honoré", "Jaune", 260, 150, 22, 110, 330, 800, 750, 1150);
		...
		this.tabCases[37] = new Propriete(partie,"Avenue des Champs-Élysées", "Bleu foncé", 350, 200, 35, 175, 500, 1100, 1300, 1500);
		this.tabCases[38] = new Taxe(partie,"Taxe de luxe");
		this.tabCases[39] = new Propriete(partie,"Rue de la Paix", "Bleu foncé", 400, 200, 50, 200, 600, 1400, 1700, 2000);
	}
